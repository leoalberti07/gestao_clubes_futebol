...
Revision ID: 9a706e197321
Revises: 
Create Date: 2026-06-23 16:56:50.938217
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('nome_atleta', sa.String(length=100), nullable=False),
    sa.Column('posicao_atleta', sa.String(length=50), nullable=False),
    sa.Column('situacao_atleta', sa.String(length=50), nullable=False),
    sa.Column('historico_atleta', sa.String(length=500), nullable=True),
